            ...
            return (
              (t.getCanvasElement = function(t) {
                ...
                if (
                  "string" == typeof t &&
                  "CANVAS" ===
                    (null != (n = e = document.querySelector(t))
                      ? n.tagName
                      : void 0)
                )
                  return e;
              ...
              (t.prototype._nextFrameRender = function() {
                ...
                if (this._running)
                  return (
                    ...
                    null != (e = this.onFrame) &&
                      e.apply(this, [t, this._frameIndex]),
                  ...
                  null == this.onFrame &&
                    (this.onFrame = (function(n) {
                      return function(i, o) {
                        ...
                        switch (
                          (null == i.buffer &&
                            (i.buffer = t.createBufferCanvas(
                              i,
                              n.width,
                              n.height
                            )),
                          "function" == typeof n.disposeFrame &&
                            n.disposeFrame(),
                          i.disposal)
                        ) {
                          case 2:
            ...
            })(
              {
                  ...
                  function(t, e, n) {
                    ...
                    for (
                      ...
                      "function" == typeof Array.prototype[v[y]] &&
                        (d.prototype[v[y]] = Array.prototype[v[y]]);
                    ...
                    e.exports = function(e, n) {
                      ...
                      function a(t) {
                        ...
                        if (!this.called) {
                          ...
                          var h =
                            0 === this.type
                              ? u.call(a._boundValue())
                              : u.call(a._boundValue(), t);
                          if (void 0 !== h) {
                            var f = n(h, a);
                            if (f instanceof e) {
                      ...
                      h.inherits(u, o),
                        ...
                        (u.prototype._promiseCancelled = function() {
                          if (!this._isResolved()) {
                            ...
                            var i = this._promise;
                            this._cleanup(),
                              t === f ? i._rejectCallback(t.e, !1) : i.cancel();
                          }
                        }),
                    ...
                    n.exports = function() {
                      ...
                      return (
                        ...
                        (i.prototype._rejectCallback = function(t, e) {
                          ...
                          this._attachExtraTrace(n, e ? r : !1),
                            this._reject(t);
                        }),
                ...
                24: [
                  function(t, e, n) {
                    ...
                    e.exports = function(e, n) {
                      ...
                      function a(t, e, n, r) {
                        for (
                          var a = p.inheritedDataKeys(t), u = [], c = 0;
                          c < a.length;
                          ++c
                        ) {
                          var l = a[c],
                      ...
                      function c(t, e, n, r, i) {
                        for (
                          ...
                          if (r === k) t[_] = k(l, f, l, h, e, i);
                            ...
                            p.notEnumerableProp(d, "__isPromisified__", !0),
                              (t[_] = d);
                          }
                        }
                      ...
                      (e.promisify = function(t, e) {
                        ...
                        (e.promisifyAll = function(t, e) {
                          ...
                          for (
                            var s = p.inheritedDataKeys(t), a = 0;
                            a < s.length;
                            ++a
                          ) {
                            var u = t[s[a]];
                            "constructor" !== s[a] &&
                              p.isClass(u) &&
                              (c(u.prototype, r, i, o, n), c(u, r, i, o, n));
                          }
                          return c(t, r, i, o, n);
                        });
                    };
                    ...
                    e.exports = function(e, n, r, i) {
                      function o(t, o) {
                        ...
                        for (
                          ...
                          var _ = t[f];
                          (void 0 !== _ || f in t) &&
                            e.cast(_)._then(l, h, void 0, c, null);
                        }
                        return c;
                      }
                      var s = t("./util"),
                    ...
                    e.exports = function(e, n) {
                        ...
                        if (l(t)) {
                          ...
                          if ("function" == typeof i) {
                            if (s(t)) {
                              var u = new e(n);
                              return (
                                t._then(u._fulfill, u._reject, void 0, u, null),
                                u
                              );
                            }
                            return a(t, i, r);
                      ...
                      function a(t, r, i) {
                        ...
                        return (
                          ...
                          a &&
                            f === c &&
                            (a._rejectCallback(f.e, !0), (a = null)),
                          l
                        );
                      }
                      var u = t("./util"),
                  ...
                  function(t, e, n) {
                    ...
                    e.exports = function(e, n) {
                      function r(t) {
                        var e = this;
                        return (
                          e instanceof Number && (e = +e), clearTimeout(e), t
                        );
                      }
                      function i(t) {
                        var e = this;
                    ...
                    e.exports = function(e, n, r, i, o, s) {
                      ...
                      (l.prototype.data = function() {
                        ...
                        (e.using = function() {
                          ...
                          if ("function" != typeof i)
                            return n(
                              "expecting a function but got " + _.classString(i)
                            );
                          var o,
                            a = !0;
                ...
                36: [
                  function(e, n, r) {
                    ...
                    function b(t) {
                      return (
                        t instanceof Error && F.propertyIsWritable(t, "stack")
                      );
                    }
                    function w(t) {
                    ...
                    var D =
                        "undefined" != typeof t &&
                        "[object process]" === w(t).toLowerCase(),
                      V = {
                        isClass: p,
                        isIdentifier: d,
                        inheritedDataKeys: P,
        ...
        function r(t, e, n, r) {
          ...
          (this.addFrame = function(e, n, r, a, c, l) {
            if (
              (d === !0 && (--s, (d = !1)),
              (l = void 0 === l ? {} : l),
              0 > e || 0 > n || e > 65535 || n > 65535)
            )
              throw "x/y invalid.";
            if (0 >= r || 0 >= a || r > 65535 || a > 65535)
              throw "Width/Height invalid.";
            if (c.length < r * a) throw "Not enough pixels for the frame size.";
            var h = !0,
              f = l.palette;
            if (
              ((void 0 === f || null === f) && ((h = !1), (f = u)),
              void 0 === f || null === f)
            )
